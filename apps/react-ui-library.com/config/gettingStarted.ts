 ...
 * builds against — older Node lines fail before React UI Library is even reached.
 */
...
export const GETTING_STARTED_STEPS: GettingStartedStep[] = [
  {
    ...
    lead: 'Add [@platform-blocks/react-ui-library](https://www.npmjs.com/package/@platform-blocks/react-ui-library) to your React Native or Expo project:',
    code: 'npm install @platform-blocks/react-ui-library',
    // note: 'This installs the core library — every component, hook, and utility.',
    language: 'bash',
  },
  {
    title: 'Install the peer dependencies',
    lead: 'React UI Library builds on a handful of packages your app provides. On Expo, install them with expo install so the versions match your SDK:',
