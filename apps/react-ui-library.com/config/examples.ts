...
export const EXAMPLES_SUBTITLE =
  'Complete screens built from React UI Library components — open one fullscreen, then copy its source into your app.';
...
export const EXAMPLES: ExampleEntry[] = [
  {
    ...
    sourcePath: 'apps/react-ui-library.com/components/examples/LoginExample.tsx',
  },
  {
    slug: 'settings',
    ...
    sourcePath: 'apps/react-ui-library.com/components/examples/SettingsExample.tsx',
  },
  {
    slug: 'dashboard',
    ...
    sourcePath: 'apps/react-ui-library.com/components/examples/DashboardExample.tsx',
  },
];
