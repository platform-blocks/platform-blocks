import type { NavTreeItem } from '@platform-blocks/react-ui-library';
...
export const NAV_SECTIONS: NavSection[] = [

  {
    ...
    items: [
      ...
      { label: 'Hooks', route: '/hooks', icon: 'hook', searchable: true, description: 'Reference for reusable React hooks in React UI Library' },
    ]
  },

  {
    ...
    items: [
      ...
      { label: 'Examples', route: '/examples', icon: 'layers', searchable: true, description: 'Complete screens built from React UI Library components — open fullscreen, then copy the source' },
      { label: 'Extensions', route: '/extensions', icon: 'package', searchable: true, description: 'Packages that build on React UI Library, and the template for making your own' },
