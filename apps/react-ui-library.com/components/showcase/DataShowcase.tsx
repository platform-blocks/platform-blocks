...
import type { DataTableSort, DataTableColumn, DataTablePagination } from '@platform-blocks/react-ui-library';
...
This playground demonstrates various **data display components** from React UI Library:
...
export default function DataShowcase() {
  ...
  const [qrText, setQrText] = useState('https://react-ui-library.com');
