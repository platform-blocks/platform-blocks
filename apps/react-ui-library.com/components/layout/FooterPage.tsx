...
import { Text, BrandButton, Flex, Block, useI18n, Grid, GridItem, Link, Title } from '@platform-blocks/react-ui-library';
        ...
        <Grid columns={12} gap={responsive.isMobile ? 'xs' : 'xl'} style={{ width: '100%', rowGap: responsive.isMobile ? 32 : 48 }}>
          <GridItem span={responsive.isMobile ? 12 : 6}>
            ...
            <Flex direction="column" gap="xs">
              ...
              <Text size="xs" color="secondary">A Platform Blocks product.</Text>
          ...
          <GridItem span={responsive.isMobile ? 4 : 2}>
            <Flex direction="column" gap="sm">
              <Text size="xs" weight="semibold" color="info" tracking={1} uppercase>Docs</Text>
              <Flex direction="column" gap="xs">
