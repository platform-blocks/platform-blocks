...
// Served from apps/react-ui-library.com/public/avatars — keeps the playground off third-party image hosts.
...
const PLAYGROUND_CONFIGS: Record<string, ComponentPlaygroundConfig> = {
  ...
  Highlight: {
    ...
    component: 'Highlight',
    initialProps: {
      children: 'React UI Library ships accessible, cross-platform UI components for React Native and web.',
  ...
  CodeBlock: {
    ...
    component: 'CodeBlock',
    initialProps: {
      children: 'import { Button } from \'@platform-blocks/react-ui-library\';\n\nexport function App() {\n  return (\n    <Button title="Launch" variant="filled" />\n  );\n}',
      language: 'tsx',
      title: 'App.tsx',
  ...
  CopyButton: {
    ...
    initialProps: {
      value: 'npm install @platform-blocks/react-ui-library',
      label: 'Copy',
      iconOnly: false,
      size: 'md',
      disableToast: false,
  ...
  Link: {
    ...
    component: 'Link',
    initialProps: {
      children: 'Visit React UI Library',
      href: 'https://react-ui-library.com',
      size: 'lg',
      variant: 'default',
      external: true,
      disabled: false,
  ...
  Spoiler: {
    ...
    initialProps: {
      ...
      children: React.createElement(
        ...
        'React UI Library is a cross-platform design system for React Native and web. This block of text is intentionally long so that the Spoiler component clips it and reveals a show/hide control. Adjust the maxHeight to change how much is visible before clipping.'
      ),
    },
