...
import { BrandIcon, DataList, Icon, Link, useTheme } from '@platform-blocks/ui';
...
export const ComponentResourceLinks: React.FC<ComponentResourceLinksProps> = ({
  ...
  const rows = useMemo<ResourceRow[]>(() => {
    ...
    const packageName = meta?.packageName || (isCharts ? '@platform-blocks/charts' : '@platform-blocks/ui');
