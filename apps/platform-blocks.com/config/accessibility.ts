...
export const ACCESSIBILITY_TITLE = 'Accessibility at Platform Blocks';
...
export const ACCESSIBILITY_SECTIONS: AccessibilitySection[] = [
  {
    ...
    lead: 'Platform Blocks is fully operable without a mouse. Focus order mirrors visual layout and shortcuts are discoverable and customizable.',
    items: [
...
export const ACCESSIBILITY_EXAMPLE_SNIPPET = `import { Button, useSpotlightToggle } from '@platform-blocks/ui';
