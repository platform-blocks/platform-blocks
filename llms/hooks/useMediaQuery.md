...
- Canonical name: `useMediaQuery`
- Package: `@platform-blocks/react-ui-library`
- Import: `import { useMediaQuery } from '@platform-blocks/react-ui-library';`
- Status: stable
- Since: 1.0.0
- Category: platform
- Tags: media-query, responsive, dimensions
- Docs: https://react-ui-library.com/hooks/useMediaQuery
- Source: https://github.com/platform-blocks/react-ui-library/tree/main/packages/ui/src/hooks/useMediaQuery
